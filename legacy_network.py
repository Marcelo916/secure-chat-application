...
def myNetwork():
    ...
    makeTerm(h4, title='Chat Server', term='xterm', cmd='sudo -E python3 tpa4_chat_server.py --host 10.0.1.3 --certfile /etc/ssl/demoCA/newcerts/chatserver-cert.pem --keyfile /etc/ssl/demoCA/private/chatserver-key.pem; bash')
    # Run the chat clients on h1, h2, and h3
    makeTerm(h1, title='Chat Client 1', term='xterm', cmd='sudo -E python3 tpa4_chat_client.py --server 10.0.1.3 --cafile /etc/ssl/demoCA/cacert.pem; bash')
    makeTerm(h2, title='Chat Client 2', term='xterm', cmd='sudo -E python3 tpa4_chat_client.py --server 10.0.1.3 --cafile /etc/ssl/demoCA/cacert.pem; bash')
    makeTerm(h3, title='Chat Client 3', term='xterm', cmd='sudo -E python3 tpa4_chat_client.py --server 10.0.1.3 --cafile /etc/ssl/demoCA/cacert.pem; bash')
